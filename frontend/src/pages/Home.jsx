    ...
    <main className="min-h-screen flex flex-col bg-white">
      ...
      <section className="bg-gradient-to-br from-blue-600 to-indigo-600 text-white py-20 px-6 md:px-20 text-center">
        ...
        <p className="text-lg md:text-xl max-w-2xl mx-auto">
          Career Compass helps you track job applications, follow up with ease,
          and never lose sight of your career goals.
        </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10 text-center">
          <div className="bg-white p-6 rounded-xl shadow hover:shadow-md transition">
            ...
            <p className="text-gray-600">
              Log job links, statuses, and deadlines in one place.
            </p>
          </div>
          <div className="bg-white p-6 rounded-xl shadow hover:shadow-md transition">
            ...
            <p className="text-gray-600">
              Set follow-up dates so you never miss an opportunity.
            </p>
          </div>
          <div className="bg-white p-6 rounded-xl shadow hover:shadow-md transition">
            ...
            <p className="text-gray-600">
              See your application progress and trends at a glance.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
          <div className="flex flex-col items-center">
            ...
            <p className="text-gray-600 max-w-xs">
              Paste the job link, set your application status, and keep it
              stored securely.
            </p>
          </div>
          <div className="flex flex-col items-center">
            ...
            <p className="text-gray-600 max-w-xs">
              Set reminders for follow-ups and receive timely alerts.
            </p>
          </div>
          <div className="flex flex-col items-center">
            <div className="bg-blue-100 text-blue-600 rounded-full h-16 w-16 flex items-center justify-center mb-4 text-xl font-bold">
            ...
            <p className="text-gray-600 max-w-xs">
              View insights on your application history to identify trends and
              opportunities.
            </p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
          <div className="bg-white p-6 rounded-xl shadow-md">
            <p className="text-gray-700 italic">
              "Career Compass helped me organize 30+ job applications with ease.
          ...
          <div className="bg-white p-6 rounded-xl shadow-md">
            <p className="text-gray-700 italic">
              "The reminders are a game changer. I followed up and landed my
              current role!"
            </p>
          ...
          <div className="bg-white p-6 rounded-xl shadow-md">
            <p className="text-gray-700 italic">
              "Simple UI, powerful features. I recommend it to all job seekers."
            </p>
        ...
        <div className="max-w-4xl mx-auto text-left space-y-6">
          <div>
            <h4 className="font-semibold text-lg text-blue-600">
              Is Career Compass free?
            </h4>
            <p className="text-gray-700">
              Yes! The basic features are completely free to use. Premium
              features may be introduced later.
            </p>
          </div>
          <div>
            <h4 className="font-semibold text-lg text-blue-600">
            ...
            <p className="text-gray-700">
              Absolutely. You can add as many job links as you want, with
              statuses and notes for each.
            </p>
          </div>
          <div>
            <h4 className="font-semibold text-lg text-blue-600">
            ...
            <p className="text-gray-700">
              Nope — Career Compass works right in your browser.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 px-6 md:px-20 bg-blue-600 text-white text-center">
        ...
        <p className="text-lg mb-8">
          Join Career Compass today and never lose track of an opportunity
          again.
        </p>
        <Button
          size="large"
      ...
      <section className="py-16 px-6 md:px-20 text-center">
        <h2 className="text-3xl font-bold mb-6">
          Stay on Track. Land Your Dream Job.
        </h2>
        <p className="text-gray-700 max-w-2xl mx-auto mb-8">
          Career Compass makes job tracking easy, so you can focus on preparing,
      ...
      <footer className="bg-gray-900 text-white py-8 mt-auto">
        <div className="container mx-auto text-center space-y-4">
          ...
          <p className="text-gray-400 text-sm">
            Your personal assistant for job application tracking.
          </p>
          ...
          <p className="text-xs text-gray-500 mt-4">
            &copy; {new Date().getFullYear()} Career Compass. All rights
            reserved.
          </p>
        </div>
      </footer>
