  ...
  return (
    <main className="w-full bg-slate-200/60 dark:bg-gray-950 p-3 sm:p-4 text-gray-900 dark:text-gray-100 font-sans min-h-full">
      <div className="max-w-4xl mx-auto space-y-4">
        <div>
          <h1 className="text-lg sm:text-xl font-extrabold tracking-tight text-gray-900 dark:text-white">Profile</h1>
          <p className="text-gray-500 dark:text-gray-400 text-xs mt-0.5">Manage your personal information and account settings</p>
        </div>
        {/* Plan Section */}
        {plan && (
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
              ...
              <div className="bg-white dark:bg-gray-700 px-4 py-3 rounded-lg border border-blue-200 dark:border-gray-600 min-w-[140px]">
                ...
                <div className="text-2xl font-bold text-gray-900 dark:text-gray-100">
                  {analysesUsed || 0}
                  <span className="text-sm text-gray-500 dark:text-gray-400 font-normal"> / {plan === 'FREE' ? 10 : plan === 'PRO' ? 50 : 200}</span>
                </div>
              </div>
            </div>
        ...
        <section className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 shadow-sm rounded-lg p-4 sm:p-6">
          ...
          <div className="flex justify-end gap-3 mt-8 pt-6 border-t border-slate-200 dark:border-gray-700">
            <button
              onClick={() => {
                fetchUser();
