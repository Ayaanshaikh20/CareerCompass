  ...
  return (
    <div className="bg-slate-100 dark:bg-gray-900 pt-4 sm:pt-6 px-2 sm:px-4 text-gray-900 dark:text-gray-100 font-sans min-h-full">
      <div className="max-w-7xl mx-auto mb-4 sm:mb-6">
        <h1 className="text-base sm:text-lg md:text-xl font-bold mb-1">Dashboard</h1>
        <p className="text-gray-600 dark:text-gray-400 text-[10px] sm:text-xs">Track your job applications at a glance</p>
      </div>

      <div className="max-w-7xl mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 mb-4 sm:mb-6">
        {[
          ...
          <div key={idx} className={`bg-gradient-to-br ${color} rounded-lg p-4 sm:p-5 text-white shadow-md`}>
            <div className="flex items-center justify-between">
              ...
              <span className="text-2xl sm:text-3xl opacity-30">{icon}</span>
            </div>
          </div>
        ))}
      </div>

      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-3 gap-4 sm:gap-6 pb-4 sm:pb-6">
        <div className="lg:col-span-2 bg-white dark:bg-gray-800 rounded-lg shadow p-4 sm:p-5">
          <h2 className="text-sm sm:text-base md:text-lg font-bold mb-3">Recent Applications</h2>
              ...
              applications.map((app, idx) => (
                ...
                >
                  <div className="flex-1">
                    <p className="font-semibold text-xs sm:text-sm">{app.role}</p>
                    <p className="text-[10px] sm:text-xs text-gray-600 dark:text-gray-400">{app.employer}</p>
                  </div>
                  <div className="text-right">
                    <p className="text-[10px] sm:text-xs font-medium">{new Date(app.appliedDate).toLocaleDateString()}</p>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow p-4 sm:p-5">
          <h2 className="text-sm sm:text-base md:text-lg font-bold mb-3">Platform Usage</h2>
